...
def single_s(request, single_slug):
    ...
    if single_slug in categories:
        ...
        return render(request=request, template_name='category.html', context={"tutorial_series": matching_series, "part_ones": series_urls})
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            for msg in form.error_messages:
                messages.error(request, "Your password don't match or is too short, please check and try again")
